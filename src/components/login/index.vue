	...
	<div class="login_container">
		<el-dialog v-model="userStore.visiable" title="用户登录">
			<div class="content">
						...
						<div class="login">
							<div v-show="scene == 0">
								<el-form>
									...
									<el-form-item>
										<el-button @click="getCode" :disabled="isPhone">
											<span v-if="flag">获取验证码</span>
											<span v-else>获取验证码({{ num }}s)</span>
										</el-button>
									</el-form-item>
								</el-form>
								<el-button
							...
							<div class="webchat" v-show="scene == 1">微信扫码登录的结构</div>
						</div>
					</el-col>
					<!-- 右 -->
					<el-col :span="12">
				...
				<!-- <template #footer> -->
				<div>
					<el-button type="primary" size="default" @click="closeScene"
						>关闭窗口</el-button
					>
				</div>
				<!-- </template> -->
...
<script setup lang="ts">
	...
	let flag = ref<boolean>(true) //倒计时控制
	let num = ref<number>(5) //倒计时
